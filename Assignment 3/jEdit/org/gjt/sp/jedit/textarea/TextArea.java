...
{
    public static FontSelector zoom;
	// global variable to control the whitespace switch
	boolean whitespace = false;
	
	// show and hide whitespace, and transfer tab, newline and space
	// to /T, /N, /S
	public void showHideWhitespace()
	{
    ...
    //{{{ ZoomIn() method
    /*zoom in/out change start*/
    public void ZoomIn(){
        zoom = new FontSelector(jEdit.getFontProperty("view.font"));
        
        int size = zoom.getFont().getSize()+10;
        Font rightFont = new Font(zoom.getName(), Font.PLAIN, size);
        
        jEdit.setFontProperty("view.font",rightFont);
        painter.setFont(rightFont);
        zoom.setFont(rightFont);
